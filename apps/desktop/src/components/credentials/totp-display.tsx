...
export function TotpDisplay({ secret }: TotpDisplayProps) {
  ...
  return (
    <div className={cn(styles.container, isLow && styles.containerExpiring)}>
      <div className={styles.readout}>
        <div className={styles.meta}>
          <span className={styles.label}>TOTP 动态验证码</span>
          <span className={cn(styles.timer, isLow && styles.timerExpiring)}>
            {remaining} 秒后刷新
          </span>
        </div>
